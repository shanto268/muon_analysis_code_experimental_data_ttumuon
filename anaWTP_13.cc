           ...
           for (int i=0; i<nhits; i++) {
              ...
              if(h.time>0) {
                ...
                if((h.layer>=0 && h.layer<=3) && (h.bb==0 || h.bb==1) && (h.ch>=0 && h.ch<=5)) {
                  if(!(node==3 && h.ch == 2)) {     // masking a channel
                      e.hits.push_back(h);
                  }
                }
              }
...
int main( int argc, char **argv ) {
   ...
   string indir="/lustre/work/sshanto/muonsc8/wtp/";
   string outdir="/lustre/work/sshanto/muonsc8/v2/root_files/";
   ...
   for(int i=0; i<nmaxRead; i++) {
      ...
      if((i%1000)==0) cout<<"event i="<<i<<endl;
